...
//    run_variants.push_back(FORALL_HYBRID_LAMBDA_TYPEFIX);
   ...
   /* START: Pavan - configuration to disable/enable printing the timing outputs. */
   #if PRINT_TIMING > 0
   ...
   #endif
   /* END: Pavan - configuration to disable/enable printing the timing outputs. */
   //
   //  Clean up.
   //
   freeLoopData();
